...
def get_daily_sales_data():
    ...
    dates = [str(today - timezone.timedelta(days=i)) for i in range(1,-1,-1)]
    values = list()
...
def get_daily_sales_quantity_data():
    ...
    for date in dates:
        ...
        quantity.append(sales_quantity)
